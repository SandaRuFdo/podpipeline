...
def main():
    ...
    p.add_argument("--language",             required=True,  help="Output language code (e.g. de, en, es)")
    p.add_argument("--language-name",        required=True,  help="Output language name (e.g. German)")
    p.add_argument("--audience",             required=True,  help="Target audience key (e.g. gen_z)")
